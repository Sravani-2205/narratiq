...
class NarrativeDetector {
  ...
  bool _hasFirstPersonSignals(String s) => RegExp(
    r"\b(i\s+(was|had|felt|saw|knew|walked|ran|thought|said|looked|heard|could|would|am|have|did|went|came|got|made|took|found)|my\s+(eyes|heart|hands|mind|voice|face|body|room|name|life)|myself)\b"
  ).hasMatch(s);
